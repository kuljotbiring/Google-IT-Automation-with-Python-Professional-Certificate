...
# that's inside the square brackets. We can read each line of the syslog and pass the
# contents to the show_time_of_pid function. Fill in the gaps to extract the date,
